...
public class ProfileController {
    ...
    @Operation(summary = "마이페이지 조회",description = "마이페이즤를 조회합니다.")
    @ApiResponse(responseCode = "200",description = "마이페이지 조회에 성공하였습니다.")
    ...
    @Operation(summary = "회원 역할 변경",description = "회원 역할을 변경합니다.")
