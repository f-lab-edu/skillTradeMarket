...
public class PhoneAuthController {
    ...
    @Operation(
            summary = "핸드폰 인증번호 받기",
            description = "핸드폰 인증합니다.",
            responses = {
                @ApiResponse(responseCode = "200",description = "핸드폰 인증번호 받기에 성공하였습니다.",content = @Content(schema = @Schema(implementation = PhoneAuthResponse.class))),
