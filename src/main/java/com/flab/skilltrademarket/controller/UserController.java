...
public class UserController {
    ...
    @Operation(
            summary = "이메일 중복 확인",
            description = "이메일 중복 확인합니다.",
            responses = {
                @ApiResponse(responseCode = "200",description = "이메일 중복 확인에 성공하였습니다.")
            }
    )
    public void checkDuplicateEmail(@Parameter(description = "이메일",example = "abcd@naver.com") @RequestParam("email") String email) {
    ...
    @Operation(
            summary = "닉네임 중복 확인",
            description = "닉네임 중복 확인합니다.",
            responses = {
                @ApiResponse(responseCode = "200",description = "닉네임 중복 확인에 성공하였습니다.")
            }
    )
    public void checkDuplicateNickName(@Parameter(description = "닉네임",example = "test1234")@RequestParam("nickName") String nickName) {
